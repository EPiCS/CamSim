...
public class SimCoreModel extends Observable {
    ...
    public void add_camera( double x_pos, double y_pos,  double heading_degrees, double angle_degrees, double range, AbstractCommunication comm, int limit, Map<String, Double> vg, String bs){
	...
	public void loadDemo(int i) {
		...
		switch (i) {
		case 1:
			this.add_camera(-15, 10, -180, 70, 20, new Broadcast(null,null), 0, null, "");
			this.add_camera(-5, 10, -180, 70, 20, new Broadcast(null,null), 0, null, "");
			this.add_camera(5, 10, -180, 70, 20, new Broadcast(null,null), 0, null, "");
			this.add_camera(15, 10, -180, 70, 20, new Broadcast(null,null), 0, null, "");
			this.add_camera(26, 8, -135, 70, 20, new Broadcast(null,null), 0, null, "");
		...
		case 3:
	      	...
	      	this.add_camera(-20, d, -180, 70, 20, new Broadcast(null,null), 0, null, "");
	      	this.add_camera(-10, d, -180, 70, 20, new Broadcast(null,null), 0, null, "");
	      	this.add_camera(10, d, -180, 70, 20, new Broadcast(null,null), 0, null, "");
	      	this.add_camera(20, d, -180, 70, 20, new Broadcast(null,null), 0, null, "");

	      	this.add_camera(-20, -d, 0, 70, 20, new Broadcast(null,null), 0, null, "");
	      	this.add_camera(-10, -d, 0, 70, 20, new Broadcast(null,null), 0, null, "");
	      	this.add_camera(10, -d, 0, 70, 20, new Broadcast(null,null), 0, null, "");
	      	this.add_camera(20, -d, 0, 70, 20, new Broadcast(null,null), 0, null, "");

	      	this.add_camera(d, -20, -90, 70, 20, new Broadcast(null,null), 0, null, "");
	      	this.add_camera(d, -10, -90, 70, 20, new Broadcast(null,null), 0, null, "");
	      	this.add_camera(d, 10, -90, 70, 20, new Broadcast(null,null), 0, null, "");
	      	this.add_camera(d, 20, -90, 70, 20, new Broadcast(null,null), 0, null, "");
