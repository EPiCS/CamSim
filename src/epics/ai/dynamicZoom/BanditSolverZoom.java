...
/**
 * Bandit solver for selecting zoom levels at runtime. Can use any implementation of the IBanditSolver class
 * 
...
public class BanditSolverZoom extends ActiveAuctionSchedule{
        ...
        /**
         * Constructor for BanditSolverZoom based on abstract AI
         * @param ai
         */
        public BanditSolverZoom(AbstractAuctionSchedule ai) {
            super(ai);
        ...
        /**
         * Constructor for BanditSolverZoom 
         * @param staticVG
         * @param vg
         * @param r
         ...
         * @param bs
         */
        public BanditSolverZoom(boolean staticVG, Map<String, Double> vg,
        ...
        /**
         * Constructor for NewActiveBCBanditRange
         * @param staticVG
         * @param vg
         * @param r
         * @param rg
...
//                _accumTotalConf = 0;
        ...
        /**
         * calculates the reward for the current zoome level
         * @return
         */
