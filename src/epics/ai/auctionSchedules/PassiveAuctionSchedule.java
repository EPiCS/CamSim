 ...
 *
 */
public class PassiveAuctionSchedule extends AbstractAuctionSchedule { //ActiveAINodeMulti {
	 ...
	 */
	public PassiveAuctionSchedule(boolean staticVG, Map<String, Double> vg, IRegistration r, RandomNumberGenerator rg){
	 ...
	 */
	public PassiveAuctionSchedule(boolean staticVG, Map<String, Double> vg, IRegistration r, RandomNumberGenerator rg, IBanditSolver bs){
	 ...
	 */
	public PassiveAuctionSchedule(AbstractAuctionSchedule ai){
		super(ai);
		if (ai instanceof PassiveAuctionSchedule) {
			PassiveAuctionSchedule pass = (PassiveAuctionSchedule) ai;
