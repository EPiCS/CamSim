 ...
 */
public class ActiveAuctionSchedule extends AbstractAuctionSchedule {
    
    /**
     * Creates an AI Node with active auction schedule from another, existing ai node
     * @param ai the existing ai node
     */
    public ActiveAuctionSchedule(AbstractAuctionSchedule ai){
    	super(ai);
    }
     ...
     */
    public ActiveAuctionSchedule(boolean staticVG, 
    ...
    /**
     * Advertises all currently tracked objects
     */
