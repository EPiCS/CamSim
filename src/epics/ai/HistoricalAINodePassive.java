 ...
 * 
 * PLEASE NOTE THAT THIS CLASS HAS A TWIN: HistoricalAINodeActive
...
public class HistoricalAINodePassive extends PassiveAINodeMulti {
	
	private HistoricalNodeHelper nodeHelper;
	
    // Overriding AbstractAINode's constructor
    public HistoricalAINodePassive(int comm, boolean staticVG, 
